...
class Animate(Sprites):
    def __init__(self, game, path, pos, scale, shift, animation_time=120):
        super().__init__(game, path, pos, scale, shift)
        self.anime_time = animation_time
    ...
    def check_animation_time(self):
        ...
        if time_now - self.animation_time_prev > self.anime_time:
